...
class OverallTestCase1(unittest.TestCase):
    ...
    def testA(self, inputStr="arwinder"):
        assert inputStr == self.decMachine.get_plainText(
            self.encMachine.get_cipherText(inputStr)
        )
...
class OverallTestCase2(unittest.TestCase):
    ...
    def testB(self, inputStr="arwinder"):
        assert inputStr == self.encMachine.get_cipherText(
            self.decMachine.get_plainText(inputStr)
        )
